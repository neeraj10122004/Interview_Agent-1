...
export class BedrockChat extends BaseChatModel {
    ...
    async _signedFetch(messages, options, fields) {
        ...
        const inputBody = this.usesMessagesApi
            ? BedrockLLMInputOutputAdapter.prepareMessagesInput(provider, messages, this.maxTokens, this.temperature, options.stop ?? this.stopSequences, this.modelKwargs, this.guardrailConfig)
            : BedrockLLMInputOutputAdapter.prepareInput(provider, convertMessagesToPromptAnthropic(messages), this.maxTokens, this.temperature, options.stop ?? this.stopSequences, this.modelKwargs, fields.bedrockMethod, this.guardrailConfig);
